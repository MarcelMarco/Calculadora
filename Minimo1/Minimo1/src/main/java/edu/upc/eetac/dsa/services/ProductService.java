...
public class ProductService {
    ...
    public Response addProduct(Product product) {
        ...
        if (product.getProductId()==null || product.getProductId()==null)  return Response.status(500).entity(product).build();
        this.productManager.addProduct(product.getProductId(), product.getProductId(), product.getPrice());
    ...
    public Response addUser(User user) {
        ...
        if (user.getId()==null || user.getUserName()==null)  return Response.status(500).entity(user).build();
        this.productManager.addUser(user.getId(), user.getUserName(), user.getUserSurname());
