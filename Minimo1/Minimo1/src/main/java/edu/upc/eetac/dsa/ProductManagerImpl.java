...
public class ProductManagerImpl implements ProductManager{
    ...
    //Lista de Productos con la que se trabaja
    List<Product> products;
    //Mapa de Usuarios con la que se trabaja
    Map<String, User> users;
    //Cola de ordenes con la que se trabaja
    Queue<Order> orders;
    ...
    @Override //Ordenamos la lista de productos por precio,con la funcion sort
    public List<Product> productsByPrice() {
        this.products.sort((Product p1,Product p2)->Double.compare(p1.getPrice(),p2.getPrice()));
        return this.products;
    }

    @Override //Ordenamos la lista de productos por ventas,con la funcion sort
    ...
    @Override //Añadimos en el mpa de usuarios un nuevo usuario
